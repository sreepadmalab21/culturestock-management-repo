...
cropdf = pd.DataFrame(cropdata=cropsheet.get_all_records())
clonesheet=gcclone.get_worksheet(0)
clonedf = pd.DataFrame(clonedata=clonesheet.get_all_records())
operatorsheet=gcoperator.get_worksheet(0)
operatordf=pd.DataFrame(operatordata=operatorsheet.get_all_records())
