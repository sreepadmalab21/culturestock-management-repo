...
with col3:
 operator=st.multiselect("Operator",options= ("NJK","SGS","ANJ","SKM","OMR","SST","ATH","SPS","SUM","SGN","AJN","ATH","ABA","BBA","CBA","DBA","EBA","FBA","GBA","HBA"))
