...
'AS301','AS301E','AS301F','AS301I','AS301J','AS301K','AS301L','AS301M','AS301N','AS301O','AS351','AS351A','AS351C','BC61','BC1','BC21','BC41','CR121C','CR121D','CF1','AG21A','AG21C','GE1','AR1','CR22','CR22A','BC1 Z','BC41 Z', 'CR121','CR41','CR61','CR81','CR102','CR141A','BC81','BC101','CR261A','CM1','AS451','CR201A','CR201C','AS151J','AS101D','AS51M','AS201K','AS1K','AS1L','AS51N'])
 clone=str(clone)[2:-2]
...
with col3:
 operator=st.multiselect("Operator",options= ("NJK","SGS","ANJ","SKM","OMR","SST","ATH",'SPS'))
